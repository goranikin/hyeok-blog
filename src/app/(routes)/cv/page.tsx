        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            <div className="flex-1">
              ...
              <p className="text-xl text-[#4A4A4A] mb-3">Janghyeok Choi</p>
              <p className="text-lg text-[#4A4A4A] leading-relaxed">
                Books, Classical Music, Climbing, Coffee, Contemparary Art,
                Marathon, Writing
              </p>
            </div>
            <Link
            ...
            <section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-[#8A8A8A] mt-1">CGPA: 3.54/4.3</p>
                </div>
              </div>
            </section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 text-base text-[#4A4A4A]">
                    <li>
                      <strong>
                        Order Quantity Prediction (Contracted Project):
                      </strong>{" "}
                      Data Pipeline, Statistical Analysis, Machine Learning
                    </li>
                    <li>
                      <strong>Customer Service Chatbot (Discontinued):</strong>{" "}
                      Data Augmentation & Refinement, LLM Agent, Prompt
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-base text-[#1A1A1A] mb-1">
                    <strong>
                      (Under Writing) DALDALL: Data Augmentation for Lexical and
                      Semantic Diverse in Legal Domain by leveraging LLM-Persona
                    </strong>
                  </p>
            ...
            <section>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-sm text-[#8A8A8A] whitespace-nowrap ml-4">
                    Mar. 2021 - Present
                  </span>
                </div>
              </div>
