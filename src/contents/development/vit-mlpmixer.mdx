...
이와 같은 implicit한 의미들을 신경망 구조에서 어떻게 이끌어낼 수 있을까요? 수학적 논리력도 중요하겠지만, 무엇보다도 언어와 인간의 지각 처리 과정에 대한 깊은 이해, 그리고 탁월한 직관력이라 감히 말해봅니다. 결국 LLM은 고전적인 algorithm에 의한 machine learning 기법이 아니니까요.
