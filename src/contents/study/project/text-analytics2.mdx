...
리팩토링하고 나니 훨씬 가독성이 좋아졌다. 디버깅과 싸우며 삽질했던 지난 날이 떠오른다. 이렇게 깔끔한 구조였다면 그렇게 시간을 오래 잡아먹진 않았을텐데. 확실히 잘 쓴 남의 코드를 보고 이해하니 바라보는 게 훨씬 달라진다. 가능하다면 언젠가 AI 관련 오픈 소스를 읽고 기여해보는 경험도 해보고 싶다.
