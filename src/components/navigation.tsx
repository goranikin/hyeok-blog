...
export const navigationItems: NavItem[] = [
  {
    ...
    subcategories: [
      ...
      { href: "/writing/diary", label: "일기" },
      { href: "/writing/thoughts", label: "찰나의 생각" },
      { href: "/writing/reviews", label: "리뷰" },
    ],
  },
  {
    href: "/study",
    ...
    subcategories: [
      ...
      { href: "/study/university", label: "학교 공부" },
  ...
  },
  {
    ...
    subcategories: [
      ...
      { href: "/laboratory/experiments", label: "실험" },
    ],
  },
];
