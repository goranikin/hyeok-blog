...
export default function LinkButton({
  ...
  return (
    <Link
      href={href}
      className={`group flex items-center justify-between p-6 rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 bg-white ${className}`}
    >
